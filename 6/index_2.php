...
<body>
    ...
    <?php else: ?>
        ...
        <form action="" method="POST">
            ...
            <?php foreach ($requests as $id => $content): ?>
                <div style="border: 1px solid; padding: 15px; margin-bottom: 15px; border-radius: 5px">
                    <label style="cursor: pointer; display: block; margin-bottom: 10px;">
                        ...
                        <span style="font-size: 12px; color: gray;">(ID строки: <?= $id ?>)</span>
                    </label>
            ...
            <div style="position: sticky; bottom: 20px; background: white; padding: 10px; border: 1px solid #ccc">
